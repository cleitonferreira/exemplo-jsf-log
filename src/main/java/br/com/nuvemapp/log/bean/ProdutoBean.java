package br.com.nuvemapp.log.bean;
...
import br.com.nuvemapp.log.model.Log;
import br.com.nuvemapp.log.model.Produto;
import br.com.nuvemapp.log.util.HibernateUtil;
...
public class ProdutoBean implements Serializable {
	...
	public void listarlog(Produto u) {
		...
		try {
			s = HibernateUtil.getSessionFactory().getCurrentSession();
			tx = s.beginTransaction();
			ls = s.createQuery("select vo from Log vo" + " where vo.tabela='produto'" + " and vo.id_tabela=" + u.getId()
